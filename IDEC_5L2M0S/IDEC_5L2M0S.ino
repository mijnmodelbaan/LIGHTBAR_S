...
/* 
 * 
 * Interactive Decoder Motor, Pauses, Reversals w/ Sound 5 LED IDEC1_1_MotSound5Led.ino
...
byte fpins []                      = { 13, 13, 14, 17, 18, 19,  3,  4,  9, 10 };
                                            //  These are all the Output Pins (first 13 is placeholder)

const int FunctionPin0             =   20;  //  D14/A0 DFPlayer Transmit (TX)  Pin 3
const int FunctionPin1             =   13;  //  A2 LED 1
const int FunctionPin2             =   14;  //  A3 LED 2
const int FunctionPin3             =   17;  //  A4 LED 3
const int FunctionPin4             =   18;  //  A5 LED 4
const int FunctionPin5             =   19;  //  A6 LED 5
...
void setup()   //******************************************************
{
   #if defined( DEBUGID ) || defined( MONITOR )
   ...
   Dcc.init( MAN_ID_DIY, 201, FLAGS_MY_ADDRESS_ONLY, 0 );
