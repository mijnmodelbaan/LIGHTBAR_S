...
{
    if( cv>=kCV_PrimaryAddress && cv<kCV_MAX && cv!=kCV_ManufacturerVersionNo && cv!=kCV_ManufacturedID )
    {
        gCV[cv] = data;
    }
}
...
void DCC_Decoder::State_Execute()
{
    ...
    {
            ///////////////////////////////////////////////////////////
            // Handle as a extended accessory decoder packet  (4 bytes)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Heartbeat function. Dispatch the dcc_decoder library state machine.
//
